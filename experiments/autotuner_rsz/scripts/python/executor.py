"""TCL generator for autotuner trials.

Builds run_plan.tcl for a single sequence-type plan:
    {"plan_type": "sequence",
     "sequence":  [<move>, ...],
     "run_knobs": {repair_tns, max_passes, max_iterations, setup_margin, ...}}

Used by autotuner.py to materialise each Optuna trial as an OpenROAD script.
"""
