"""
autotuner_rsz/autotuner.py — Core AutoTuner logic for repair_timing hyperparameter search.
...
def run_autotuner(
    ...
    autotuner_root — autotuner_rsz/, all results written here
    ...
    if not base_cts_odb.exists():
        raise FileNotFoundError(
            ...
            "Run 'python3 autotuner_rsz/run_autotuner.py --run-stage base' first."
        )
