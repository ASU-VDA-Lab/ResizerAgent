...
#   1. DPL + estimate_parasitics -placement (POST-LEGALIZATION)
#   2. write_db + write_sdc  (handoff — seed for next iteration; ORFS runs GR in backend)
#   3. generate_design_artifacts (at-placement timing/area/power/paths)
# NO placement report and NO global route — this ablation gives the agents zero
# physical/spatial information; the loop reports only at-placement timing metrics.
_POSTAMBLE = """\
